...
\input{elementos-pre-textuais/capa}
\input{elementos-pre-textuais/folha-rosto}
...
\input{elementos-pre-textuais/dedicatoria}          % Dedicatória
\input{elementos-pre-textuais/agradecimentos}       % Agradecimentos
\input{elementos-pre-textuais/epigrafe}             % Epígrafe
\input{elementos-pre-textuais/resumo-pt}            % Resumo
\input{elementos-pre-textuais/resumo-en}            % Abstract
...
\input{elementos-pre-textuais/lista-siglas}         % Lista de siglas
\input{elementos-pre-textuais/lista-simbolos}       % Lista de símbolos
\imprimirsumario                                    % Sumário

% Configura layout para os elementos textuais
\textual
\input{elementos-textuais/introducao}               % Introdução
\input{elementos-textuais/trabalhos-relacionados}   % Trabalhos relacionados
\input{elementos-textuais/fundamentacao-teorica}    % Fundamentação teórica
\input{elementos-textuais/metodologia}              % Metodologia
\input{elementos-textuais/resultados}               % Resultados
\input{elementos-textuais/conclusao}                % Conclusão

% Configura layout para os elementos pós-textuais
\postextual
\imprimirreferencias                                % Referências
\input{elementos-pos-textuais/apendices}            % Apêndices
\input{elementos-pos-textuais/anexos}               % Anexos

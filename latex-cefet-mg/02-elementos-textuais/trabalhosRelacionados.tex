...
As citações são utilizadas no texto com o propósito de esclarecer, completar, embasar ou corroborar as idéias do autor.
...
Nas citações livres, reproduzem-se as idéias e informações de um autor, sem, entretanto, ``copiar letra-por-letra'' o texto do autor.
...
Nas citações literais, reproduzem-se as idéias e informações de um autor, exatamente como este a expressou, ou seja, faz-se uma ``copia letra-por-letra'' do texto do autor.
...
\citeonline[p.~33]{morinmoigne:2000}, ao fazerem as suas críticas à ciência, explicitam uma idéia coletiva:

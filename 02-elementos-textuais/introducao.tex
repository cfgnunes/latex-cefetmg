...
Todavia, há vários elementos do documento que sofrem conversão de minúsculas e maiúsculas - por exemplo o conteúdo dos arquivos {\ttfamily .bib}, {\ttfamily capa.tex} e {\ttfamily folhaRosto.tex}, além de títulos de capítulos, seções, etc..
Para estes elementos, pelo menos, não acentue diretamente as palavras, use os comandos relacionados na \autoref{fig:acentos_latex}.
...
\begin{figure}[!htb]
    ...
    \label{fig:acentos_latex}
\end{figure}

Para a compilação de arquivos \TeX{} ou \LaTeX{} veja os comandos apresentados na \autoref{fig:comandos_compila_tex}.
...
\begin{figure}[!htb]
    ...
    \label{fig:comandos_compila_tex}
\end{figure}

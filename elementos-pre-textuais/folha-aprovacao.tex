...
\begin{folhadeaprovacao}
    ...
    \assinatura{Nome do convidado 1 \\ Instituição do convidado 1}
    \assinatura{Nome do convidado 2 \\ Instituição do convidado 2}
    %\assinatura{Nome do convidado 3 \\ Instituição do convidado 3}
    %\assinatura{Nome do convidado 4 \\ Instituição do convidado 4}

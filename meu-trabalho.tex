...
% Use o comando abaixo para usar o modelo de
% ficha catalográfica deste template...
%\input{elementos-pre-textuais/ficha-catalografica.tex} % Ficha catalográfica

% ...ou então, use o comando abaixo para importar uma
% ficha catalográfica fornecida, no formato PDF.
\importarfichacatalografica{ficha-catalografica.pdf}    % Ficha catalográfica

% Use o comando abaixo para usar o modelo de
% folha de aprovação deste template...
\input{elementos-pre-textuais/folha-aprovacao.tex}      % Folha de aprovação

% ...ou então, use o comando abaixo para importar uma
% folha de aprovação digitalizada, no formato PDF.
%\importarfolhadeaprovacao{folha-aprovacao.pdf}         % Folha de aprovação

...
\begin{apendicesenv}
    ...
    \begin{figure}[!htb]
        ...
        \subtop[][Figura exemplo.]{%
            \includegraphics[scale=0.2]{figuras/figura_exemplo_2.jpg}%
...
\end{verbatim}
    ...
    Sendo mais explícito, ao baixar um arquivo \textbf{.bib} de um trabalho, principalmente se for internacional, e inseri-lo ``\textit{as is}'' em suas referências, há grande chance dessa referência ser formatada de modo errado, no que concerne à norma \citeonline{NBR6023:2002}.

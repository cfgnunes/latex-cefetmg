...
% Use o comando abaixo para usar um modelo de ficha catalográfica...
%\input{elementos-pre-textuais/ficha-catalografica.tex}
% ...ou use o comando abaixo para importar uma ficha fornecida no formato PDF
\importarfichacatalografica{ficha-catalografica.pdf}

...
% EStilo para impressão apenas no anverso
%\documentclass[oneside]{cefetmg}

% Estilo para impressão em frente (anverso) e verso
%\documentclass[twoside]{cefetmg}

% Estilo para mostrar a palavra "Capítulo" no início de cada capítulo

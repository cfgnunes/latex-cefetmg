...
A Figura \ref{fig:kdtree} aparece automaticamente na lista de figuras.
...
Também é apresentado o exemplo do Quadro \ref{qua:vertices} e da Tabela \ref{tab:correlacao}, que aparece automaticamente na lista de quadros e tabelas.

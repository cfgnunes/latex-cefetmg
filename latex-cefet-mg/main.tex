...
% elementos pré textuais
	...
	\include{./elementos-pre-textuais/folhaAprovacao}	% Folha de aprovação
	...
	\include{./elementos-pre-textuais/listaIlustracoes}	% Lista de ilustrações
	%\listadequadros					% Lista de quadros
	\include{./elementos-pre-textuais/listaTabelas}		% Lista de tabelas
	\include{./elementos-pre-textuais/listaSiglas}		% Lista de abreviaturas e siglas
	\include{./elementos-pre-textuais/listaSimbolos}	% Lista de símbolos
